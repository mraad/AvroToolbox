...
/**
 */
public final class ExportToAvroParquetTool extends AbstractTool
{
    private static final long serialVersionUID = -3738251839310183607L;

    public static final String NAME = ExportToAvroParquetTool.class.getSimpleName();
    ...
    public IArray getParameterInfo() throws IOException, AutomationException
    {
        ...
        addParamString(parameters, "Remote output path", "in_output_path", "hdfs://localhost:8020/user/" + username + "/features.avro");
